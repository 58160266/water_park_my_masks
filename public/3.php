...
<head>
  ...
  $(document).ready(function(){
      $.get("https://angsila.cs.buu.ac.th/~58160266/reatful/public/index.php/api/v1/waterparks/3", function(data, status){
  ...
  <div class="w3-row">  <!-- The Grid -->
    ...
    <div class="w3-col m3">  <!-- Left Column -->
      ...
      <div class="w3-card w3-round w3-white"> <!-- Profile -->
        <div class="w3-container">
         ...
         <a href="3.php" class="list-group-item active"> 3. Splash Jungle Water Park</a>
            ...
            <div class="modal-dialog">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <p>กรุณายืนยันว่าคุณได้ไปที่ Splash Jungle Water Park มาแล้ว </p>
                </div>
                <div class="modal-footer">
                  <button type="button" class="btn btn-default" onclick="getMission(3);"data-dismiss="modal">ตกลง</button>
    ...
    <div class="w3-col m2"> <!-- Right Column -->
      <div class="w3-card w3-round w3-white w3-center">
          <!-- fb page sdk -->
          <div class="fb-page" data-href="https://www.facebook.com/splashjungle.waterpark/" data-tabs="timeline" data-height="805" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="https://www.facebook.com/splashjungle.waterpark/" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/splashjungle.waterpark/">Splash Jungle Water Park Phuket</a></blockquote></div>
         <!--End fb page sdk -->
      </div>
