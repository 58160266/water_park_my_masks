...
<div class="w3-container w3-content" style="max-width:2500px;margin-top:30px">    <!-- Page Container -->
    ...
    <div class="w3-col m3">  <!-- Left Column -->
      ...
      <div class="w3-card w3-round w3-white"> <!-- Profile -->
        <div class="w3-container">
         ...
         <a href="11.php" class="list-group-item active"> 11.  Cartoon Network Amazon </a>
 ...
 <div class="w3-col m2"> <!-- Right Column -->
      <div class="w3-card w3-round w3-white w3-center">
          <!-- fb page sdk -->
          <div class="fb-page" data-href="https://web.facebook.com/CNAmazoneThailand/" data-tabs="timeline" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true" data-height="805">
            <blockquote cite="https://web.facebook.com/CNAmazoneThailand/" class="fb-xfbml-parse-ignore">
              <a href="https://web.facebook.com/CNAmazoneThailand/">Cartoon Network Amazone</a>
            </blockquote>
          </div>
         <!--End fb page sdk -->
      </div>
