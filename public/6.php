...
<head>
  ...
  $(document).ready(function(){
      $.get("https://angsila.cs.buu.ac.th/~58160266/reatful/public/index.php/api/v1/waterparks/6", function(data, status){
  ...
  <div class="w3-row">  <!-- The Grid -->
    ...
    <div class="w3-col m3">  <!-- Left Column -->
      ...
      <div class="w3-card w3-round w3-white"> <!-- Profile -->
        <div class="w3-container">
         ...
         <a href="6.php" class="list-group-item active"> 6. Grand Canyon Water Park</a>
                  ...
                  <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <p>กรุณายืนยันว่าคุณได้ไปที่ Grand Canyon Water Park มาแล้ว </p>
                      </div>
                      <div class="modal-footer">
                        <button type="button" class="btn btn-default" onclick="getMission(6);"data-dismiss="modal">ตกลง</button>
    ...
    <div class="w3-col m2"> <!-- Right Column -->
      <div class="w3-card w3-round w3-white w3-center">
          <!-- fb page sdk -->
          <div class="fb-page" data-href="https://www.facebook.com/Grandcanyonwaterpark/" data-tabs="timeline" data-height="805" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="https://www.facebook.com/Grandcanyonwaterpark/" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/Grandcanyonwaterpark/">Grand Canyon Water Park</a></blockquote></div>
         <!--End fb page sdk -->
      </div>
