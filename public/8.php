  ...
  <div class="w3-row">  <!-- The Grid -->
    ...
    <div class="w3-col m2"> <!-- Right Column -->
      <div class="w3-card w3-round w3-white w3-center">
          <!-- fb page sdk -->
          <div class="fb-page" data-href="https://web.facebook.com/dinowaterparkkhonkaen?_rdc=1&_rdr" data-tabs="timeline" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true" data-height="805">
            <blockquote cite="https://web.facebook.com/dinowaterparkkhonkaen?_rdc=1&_rdr" class="fb-xfbml-parse-ignore">
              <a href="https://web.facebook.com/dinowaterparkkhonkaen?_rdc=1&_rdr">Dino Water Park</a>
            </blockquote>
          </div>
         <!--End fb page sdk -->
      </div>
