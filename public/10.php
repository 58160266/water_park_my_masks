...
<head>
  ...
  $(document).ready(function(){
      $.get("https://angsila.cs.buu.ac.th/~58160266/reatful/public/index.php/api/v1/waterparks/10", function(data, status){
  ...
  <div class="w3-row">  <!-- The Grid -->
    ...
    <div class="w3-col m3">  <!-- Left Column -->
      ...
      <div class="w3-card w3-round w3-white"> <!-- Profile -->
        <div class="w3-container">
         ...
         <a href="10.php" class="list-group-item active"> 10.  SiamParkCity</a>
    ...
    <div class="w3-col m2"> <!-- Right Column -->
      <div class="w3-card w3-round w3-white w3-center">
          <!-- fb page sdk -->
          <div class="fb-page" data-href="https://web.facebook.com/siamparkcity.fanpage/?_rdc=1&_rdr" data-tabs="timeline" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true" data-height="805">
            <blockquote cite="https://web.facebook.com/siamparkcity.fanpage/?_rdc=1&_rdr" class="fb-xfbml-parse-ignore">
              <a href="https://web.facebook.com/siamparkcity.fanpage/?_rdc=1&_rdr">Siamparkcity สวนสยามทะเล-กรุงเทพฯ</a>
            </blockquote>
          </div>
         <!--End fb page sdk -->
      </div>
