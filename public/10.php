  ...
  <div class="w3-row">  <!-- The Grid -->
    ...
    <div class="w3-col m3">  <!-- Left Column -->
      ...
      <div class="w3-card w3-round w3-white"> <!-- Profile -->
        <div class="w3-container">
         ...
         <a href="10.php" class="list-group-item active"> 10.  Siam Park City</a>
            ...
            <div class="modal-dialog">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <p>กรุณายืนยันว่าคุณได้ไปที่ Siam Park City มาแล้ว </p>
                </div>
    ...
    <div class="w3-col m2"> <!-- Right Column -->
      <div class="w3-card w3-round w3-white w3-center">
          <!-- fb page sdk -->
          <div class="fb-page" data-href="https://www.facebook.com/siamparkcity.fanpage/" data-tabs="timeline" data-height="805" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="https://www.facebook.com/siamparkcity.fanpage/" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/siamparkcity.fanpage/">Siamparkcity สวนสยามทะเล-กรุงเทพฯ</a></blockquote></div>
         <!--End fb page sdk -->
      </div>
